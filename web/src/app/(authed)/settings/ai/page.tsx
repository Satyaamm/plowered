      ...
      <DialogBody>
        ...
        <DialogContent>
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            ...
            <Field
              label={
                <InfoLabel info="A label only your tenant sees — e.g. 'Claude Opus (prod)' or 'OpenAI fallback'. Used in audit logs and the provider dropdown when multiple are configured for the same capability.">
                  Nickname
                </InfoLabel>
              }
              required
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
              <Field
                label={
                  <InfoLabel info="The exact model ID the provider expects in API calls — case-sensitive. Plowered sends it verbatim; if you mistype here, every call fails with a 'model not found' error.">
                    Model
                  </InfoLabel>
                }
                required
              ...
              <Field
                label={
                  <InfoLabel info="Chat: text generation, glossary auto-write, semantic answers. Embeddings: vector representations for semantic search. Each provider entry serves exactly one capability; configure two providers if you need both.">
                    Capability
                  </InfoLabel>
                }
                required
                ...
                <InfoLabel
                  info={
                    kind === "openai-compatible"
                      ? "Required for OpenAI-compatible gateways. Point at any /v1-style endpoint — LiteLLM, Ollama, OpenRouter, vLLM, etc. Include the protocol and port; do not include a trailing slash."
