              ...
              <DialogBody>
                ...
                <DialogContent>
                  <div className={styles.formStack}>
                    <Field
                      label={
                        <InfoLabel info="The litigation or regulator reference this hold ties to. Required for audit defensibility — courts ask for it during e-discovery. Use your organisation's matter-management ID (e.g. case-2026-04, IR-2026-Q1-15).">
                          Matter
                        </InfoLabel>
                      }
                      required
